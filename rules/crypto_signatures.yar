/*
 * The original contents of this file were taken from https://github.com/Yara-Rules/rules with some modifications/additions.
 * Other sources include:
 *   - https://github.com/polymorf/findcrypt-yara
 *   - https://github.com/Rami114/cryptoscan/tree/master/scans
 *   - https://github.com/you0708/ida/blob/master/idapython_tools/findcrypt/consts.py
 *
 * This Yara ruleset is under the GNU-GPLv2 license (http://www.gnu.org/licenses/gpl-2.0.html) and open to any user or organization,
...
rule Chacha_128_constant {
    meta:
        author = "spelissier"
        description = "Look for 128-bit key Chacha/Salsa stream cipher constant"
        date = "2019-12"
        reference = "https://www.ecrypt.eu.org/stream/salsa20pf.html"
    strings:
        $c0 = "expand 16-byte k" wide ascii
    condition:
        $c0
}
...
rule Chacha_256_constant {
    meta:
        author = "spelissier"
        description = "Look for 256-bit key Chacha/Salsa stream cipher constant"
        date = "2019-12"
        reference = "https://tools.ietf.org/html/rfc8439#page-8"
    strings:
        $c0 = "expand 32-byte k" wide ascii
    condition:
        $c0
}
...
rule SM3_init {
    meta:
        ...
        description = "Detects the IV used in the SM3 hash init"
        reference = "https://tools.ietf.org/id/draft-oscca-cfrg-sm3-02.html"
        date = "2020-11"
    strings:
        $c0 = { 7380166f }
        $c1 = { 4914b2b9 }
...
rule SM3_constants {
    meta:
        author = "starfleetcadet75"
        description = "Detects the constants used by SM3"
        reference = "https://tools.ietf.org/id/draft-oscca-cfrg-sm3-02.html"
        date = "2020-11"
    strings:
        $c0 = { 79cc4519 }
...
rule SM4_ConstantKey {
    meta:
        author = "starfleetcadet75"
        description = "Detects the constant key (CK) values used in SM4"
        reference = "https://tools.ietf.org/html/draft-ribose-cfrg-sm4-10"
        date = "2020-11"
    strings:
        $ck0 = { 00070E15 }
        $ck1 = { 1C232A31 }
...
rule SM4_FamilyKey {
    meta:
        author = "starfleetcadet75"
        description = "Detects the family key (FK) values used in SM4"
        reference = "https://tools.ietf.org/html/draft-ribose-cfrg-sm4-10"
        date = "2020-11"
    strings:
        $fk0 = { A3B1BAC6 }
...
rule SM4_sbox {
    meta:
        author = "starfleetcadet75"
        description = "Detects the SM4 sbox table"
        reference = "https://tools.ietf.org/html/draft-ribose-cfrg-sm4-10"
        date = "2020-11"
    strings:
